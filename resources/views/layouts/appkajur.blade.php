...
<body>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-xl-inline">
            ...
            <div class="dropdown-menu dropdown-menu-center navbar-dropdown center-block" aria-labelledby="UserDropdown">
              
              <a class="dropdown-item center-block" style="margin-top: 20px;" href="{{url('editkajur')}}">
               Edit Profile
              </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      @section('sidebar')
          @include('kajur.sidebar',['user' => Auth::User()])
      @show
      </nav>
