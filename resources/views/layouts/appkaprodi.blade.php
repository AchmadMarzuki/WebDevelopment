...
<body>
        ...
        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                               ...
                               <i class="fa fa-2x fa-bell" style="color:#ffffff;"></i>
                                ...
                                <span class="badge"
                                      ...
                                      <a href="{{url('/listvalidasiKaprodi')}}">
                                 </a>
                                </span>
                            </a>
                          <ul class="dropdown-menu" role="menu">
                          <a href="{{url('/listvalidasiKaprodi')}}" title="friends">
                                   <p><center><h4>Show</h4></center></p>
                                 </a>
         ...
         <li class="nav-item dropdown d-xl-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown text-center" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" style="margin-top: 20px;" href="{{url('editKaprodi')}}">
               Edit Profile
              </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      @section('sidebar')
          @include('kaprodi.sidebar',['user' => Auth::User()])
      @show
      </nav>
